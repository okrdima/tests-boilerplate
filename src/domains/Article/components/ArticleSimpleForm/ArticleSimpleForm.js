  ...
  return group ? (
    <>
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            message: t('Please enter your article name!')
          },
          { max: MAX_LENGTH_FIELD, message: t('article name is too long!') }
        ]}>
        <Input
          placeholder={t('Please enter your article name')}
    ...
    <Form
      ...
      <Form.Item
        ...
        <Input placeholder={t('Please enter your article name')} />
      </Form.Item>
      {!form && (
        <>
